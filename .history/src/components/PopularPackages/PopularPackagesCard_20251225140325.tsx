 ...
 <Image src={image} alt={title} width={400} height={300} className="w-full h-[340px] object-center lg:object-cover" />
  <div className="p-[25px] flex flex-col gap-4">
   <div className="flex flex-col gap-4">
    ...
    <button className="py-3 px-6 border text-orange font-semibold text-[20px] border-orange rounded-[50px] transition-colors duration-300 hover:bg-orange hover:text-white">    Book Now
                </button>
            </div>
    </div>
  )
