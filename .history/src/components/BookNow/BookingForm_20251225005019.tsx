...
const BookingForm = () => {
 ...
 <div key={index} className="flex flex-col gap-2">
   <label className="font-semibold text-lg text-black01">{data.title}</label>
    ...
    <select className="appearance-none bg-white text-black01/50 py-3.5 pr-10 pl-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange md:text-sm w-full"   >
