...
const Navbar = () => {
  ...
  return (
    ...
    <nav className={clsx( "fixed z-51  left-1/2 -translate-x-1/2 flex justify-between items-center ",// Navbar Breakpoints (Responsive Horizontal Padding)
          ...
          "transition-all duration-300 ",// Transition Behavior
          {"bg-gradient-to-b from-black/60 to-black/75 shadow-md w-[100%] mt-5 rounded-4xl py-3": scrolled && !menuOpen, //Scrolled State 
